...
log_folder = '/home/lennon.lin/Repository/github/log_folder'
...
tfrecord_filename = '/home/lennon.lin/DataSet/Segmentation/Pacal_Berkely/pascal_augmented_train.tfrecords'
...
with tf.Session()  as sess:
    ...
    for i in xrange(11127 * 10):
        ...
        print("i = %d,  Current loss: " + str(cross_entropy), i)
        
        summary_string_writer.add_summary(summary_string, i)
        
        if i % 11127 == 0:
            save_path = saver.save(sess, "/home/lennon.lin/Repository/github/segmentation/model_fcn32s.ckpt")
